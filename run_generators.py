...
def run_generators():
    ...
    generate_pe_tile('pe_tile_bottom_left', 'switch_box_bottom_left', [0, 3], 4, 4)
    ...
    generate_pe_tile('pe_tile_bottom_right', 'switch_box_bottom_right', [2, 3], 4, 4)
