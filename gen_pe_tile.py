...
def generate_pe_verilog(mod_name, switch_box_mod, sides_to_use, n_sides, n_wires_per_side, is_bottom):
    ...
    mod.add_instance('address_matcher', 'cb0_address_matcher', {'config_flag_value' : cb0_addr, 'tile_id_end' : tile_id_end, 'tile_id_begin' : tile_id_begin, 'mod_id_end' : mod_id_end, 'mod_id_begin' : mod_id_begin})
    ...
    mod.add_instance('address_matcher', 'cb1_address_matcher', {'config_flag_value' : cb1_addr, 'tile_id_end' : tile_id_end, 'tile_id_begin' : tile_id_begin, 'mod_id_end' : mod_id_end, 'mod_id_begin' : mod_id_begin})    
    ...
    mod.add_instance('address_matcher', 'sb_address_matcher', {'config_flag_value' : sb_addr, 'tile_id_end' : tile_id_end, 'tile_id_begin' : tile_id_begin, 'mod_id_end' : mod_id_end, 'mod_id_begin' : mod_id_begin})        
    ...
    mod.add_instance('address_matcher', 'logic_block_address_matcher', {'config_flag_value' : clb_addr, 'tile_id_end' : tile_id_end, 'tile_id_begin' : tile_id_begin, 'mod_id_end' : mod_id_end, 'mod_id_begin' : mod_id_begin})
